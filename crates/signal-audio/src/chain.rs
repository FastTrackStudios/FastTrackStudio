//! Processing chain placeholder for live audio output.
...
///
/// This intentionally runs as a pass-through while the standalone EQ and
/// compressor crates are out of the app's active build.
///
...
pub struct ProcessingChain {
    ...
    ///
    /// Kept for UI compatibility while dynamics processing is disabled.
