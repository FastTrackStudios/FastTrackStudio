...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AuthUsers::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthUsers::Metadata)
                            .json()
                            .not_null()
                            .default("{}"),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthUsers::Banned)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AuthSessions::Token)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthSessions::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthSessions::Active)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AuthAccounts::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthAccounts::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(AuthOrganizations::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthOrganizations::Slug)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthOrganizations::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthOrganizations::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AuthMembers::Role)
                            .string()
                            .not_null()
                            .default("member"),
                    )
                    .col(
                        ColumnDef::new(AuthMembers::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(AuthInvitations::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthInvitations::Role)
                            .string()
                            .not_null()
                            .default("member"),
                    )
                    .col(
                        ColumnDef::new(AuthInvitations::Status)
                            .string()
                            .not_null()
                            .default("pending"),
                    )
                    .col(
                        ColumnDef::new(AuthInvitations::InviterId)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthInvitations::ExpiresAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthInvitations::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(AuthVerifications::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthVerifications::ExpiresAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthVerifications::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthVerifications::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(AuthTwoFactor::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthTwoFactor::UserId)
                            .string()
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(AuthTwoFactor::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(AuthTwoFactor::UpdatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AuthApiKeys::Enabled)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(AuthPasskeys::BackedUp)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .col(
                        ColumnDef::new(AuthPasskeys::CreatedAt)
                            .timestamp_with_time_zone()
                            .not_null(),
                    )
                    .to_owned(),
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(AuthPasskeys::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthApiKeys::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthTwoFactor::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthVerifications::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthInvitations::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthMembers::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthOrganizations::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthAccounts::Table).to_owned())
            .await?;
        manager
