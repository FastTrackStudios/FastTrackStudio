...
use crate::service::{
    ...
    ExerciseProgressView, FitnessService, LogSetRequest, RoutineWithExercisesView,
    StartWorkoutSessionRequest, TopSet, UpdateSetRequest, VaultError, WorkoutSessionView,
};
