...
async fn all_actions_registered(ctx: &ReaperTestContext) -> eyre::Result<()> {
    ...
    let dynamic_template = [
        ...
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_DRUMS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_DRUM_KIT",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_ELECTRONIC_KIT",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_PERCUSSION",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_BASS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_BASS_GUITAR",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_BASS_SYNTH",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_UPRIGHT_BASS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_GUITARS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_ELECTRIC_GUITAR",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_ACOUSTIC_GUITAR",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_KEYS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_PIANO",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_ORGAN",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_ELECTRIC_KEYS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_SYNTHS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_SYNTH_LEAD",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_SYNTH_PAD",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_SYNTH_ARP",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_HORNS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_TRUMPET",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_TROMBONE",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_SAXOPHONE",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_HARMONICA",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_STRINGS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_VOCALS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_LEAD_VOCALS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_BACKGROUND_VOCALS",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_CHOIR",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_ORCHESTRA",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_SFX",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_GUIDE",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_REFERENCE",
        "FTS_DYNAMIC_TEMPLATE_CREATE_NEW_STEM_SPLIT",
    ];
