//! Person feature route. Holds a local `CrdtDoc` + `PersonRepoLoro`,
//! syncs over WebSocket, drives `person-ui` dumb components.
...
#[component]
pub fn PersonView() -> Element {
    let repo: Rc<PersonRepoLoro> = use_hook(|| {
