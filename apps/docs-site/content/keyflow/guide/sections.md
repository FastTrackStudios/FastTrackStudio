...
Below the [header](/keyflow/guide/structure/), a chart is a stack of **sections** — the
...
[Structure](/keyflow/guide/structure/)) to its header, and it takes effect from the top
of that section.
