...
The [header](/keyflow/guide/structure/) sets the song's starting key and time signature.
...
(`BR 8 #Ab`) — see [Sections](/keyflow/guide/sections/).
...
[chord duration](/keyflow/guide/rhythm/) — here it scopes the meter change to a single
