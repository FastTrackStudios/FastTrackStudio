...
[Sections](/keyflow/guide/sections/).
...
You now have every layer of a Keyflow chart: the [header](/keyflow/guide/structure/), the
[sections](/keyflow/guide/sections/) that organize the song, [chords](/keyflow/guide/chords/) in
any of the [three systems](/keyflow/guide/notation-systems/), their
[rhythm](/keyflow/guide/rhythm/), a [melody](/keyflow/guide/melody/), and the lyrics underneath.
