...
extensions, alterations, slash bass (see [Chords](/keyflow/guide/chords/)) — works
...
[Chords](/keyflow/guide/chords/) page: **secondary chords** with `/` (`V/V` is "five of
...
[header](/keyflow/guide/structure/) (`#C`, `#Gm`, …). Because the chart stores *degrees*
...
[Melody](/keyflow/guide/melody/) page.
