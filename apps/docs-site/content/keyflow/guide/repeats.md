...
`%` replays the bar before it (from [Rhythm](/keyflow/guide/rhythm/)):
...
[header](/keyflow/guide/structure/) and [sections](/keyflow/guide/sections/), the
[chords](/keyflow/guide/chords/), [rhythm](/keyflow/guide/rhythm/), [melody](/keyflow/guide/melody/), and
[lyrics](/keyflow/guide/lyrics/), the [key and meter changes](/keyflow/guide/key-meter-changes/),
the [markings](/keyflow/guide/annotations/), and now the repeats that tie a song's form
