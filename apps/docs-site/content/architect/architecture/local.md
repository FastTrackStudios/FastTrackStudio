...
[idioms §7 — inject the transport, not the backend](@/architect/architecture/idioms.md):
...
[server push](@/architect/architecture/streams.md).)
...
| **Tests** | full-wire coverage at unit-test speed; see [testing strata](@/architect/architecture/testing.md) |
