...
([idioms §6](@/architect/architecture/idioms.md)). `architect::resource` answers
...
[`Services`](@/architect/architecture/idioms.md) bundle —
...
[in-process transport](@/architect/architecture/local.md) for desktop/CLI/tests.
