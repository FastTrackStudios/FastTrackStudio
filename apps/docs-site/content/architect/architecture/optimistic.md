...
[idioms §6](@/architect/architecture/idioms.md)). `architect-atom` is the
...
mutations (see [composing the UI](@/architect/architecture/composing-the-ui.md)).
...
through vox ([idioms §1](@/architect/architecture/idioms.md)), so the Dioxus
