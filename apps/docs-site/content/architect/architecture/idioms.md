...
[construction](@/architect/architecture/construction.md).
...
See [scheduling & resilience](@/architect/architecture/scheduling.md) for the full
...
[composing the UI](@/architect/architecture/composing-the-ui.md).
...
walkthrough: [optimistic state](@/architect/architecture/optimistic.md).
...
walkthrough: [forms](@/architect/architecture/forms.md).
