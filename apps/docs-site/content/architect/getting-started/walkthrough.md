...
`ExampleRepoStorage<C>`. See [the architect pattern](@/architect/architecture/pattern.md)
...
(`impl ExampleRepo for RoutingRepo`); see [idioms §7](@/architect/architecture/idioms.md).
...
([idioms §6](@/architect/architecture/idioms.md)):
...
See [testing strata](@/architect/architecture/testing.md). Run `cargo nextest run
