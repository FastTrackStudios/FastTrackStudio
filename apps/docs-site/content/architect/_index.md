...
- [Getting started](@/architect/getting-started/_index.md) — get the dev shell up,
  run the e2e tests, see the contract round-trip from a browser.
- [**Build a feature, end to end**](@/architect/getting-started/walkthrough.md) —
  the fastest way to learn how to *use* architect: define an entity, pick
  a backend, serve it, consume it remote or in-process.
- [Architecture](@/architect/architecture/_index.md) — the patterns the template
...
- [Reference](@/architect/reference/_index.md) — the crate map, derive
