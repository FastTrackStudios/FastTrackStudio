...
Text formats are [styx](/guide/styx-guide/) (`.styx`) parsed via `facet_styx`; a `.toml` spec is
...
[GGD Modern & Massive 2 map](/signal/ggd-modern-massive-2-mapping/) for a full kit
built this way.
...
- [GGD Modern & Massive 2 Map](/signal/ggd-modern-massive-2-mapping/) — concrete
  hand-pair mapping built on these formats.
- [Sampler Roadmap](/signal/sampler-roadmap/) — where the playback engine is headed.
