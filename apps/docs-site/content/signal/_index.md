...
- [Getting Started](/signal/getting-started/) — Building and running Signal plugins
- [Architecture](/signal/architecture/) — How Signal is structured
- [Sampler Roadmap](/signal/sampler-roadmap/) — Kontakt-class sampler playback and product plan
- [Sampler File Formats & Mapping](/signal/sampler-file-formats/) — Preset/Engine/Block/Module/Pack formats and how MIDI mapping works
- [GGD Modern & Massive 2 Map](/signal/ggd-modern-massive-2-mapping/) — Hand-pair MIDI mapping convention for drum kits
