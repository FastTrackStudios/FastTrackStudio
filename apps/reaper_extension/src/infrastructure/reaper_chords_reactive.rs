...
use fts::chords::reactive::{ChordsReactiveService, ChordsReactiveState, ChordsStreams};
use fts::chords::types::ChordsData;
...
impl ReaperChordsReactiveService {
    ...
    fn emit_chords(&self, project_name: String, chords: ChordsData) {
        self.streams.chords_changed.borrow_mut().next((project_name, chords));
    }
}
