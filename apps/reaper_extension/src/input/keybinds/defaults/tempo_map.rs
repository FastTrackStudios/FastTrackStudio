...
pub fn tempo_map_override() -> KeybindOverride {
    ...
    .with_bindings(vec![
        ...
        Keybind::new("<A-g>", "FTS_TEMPO_MOVE_MEASURE_GRID_TO_MOUSE_FULLY_CONSTRAINED")
        ...
        Keybind::new("<A-t>", "FTS_TEMPO_SNAP_GRID_TO_TRANSIENT_FULLY_CONSTRAINED")
