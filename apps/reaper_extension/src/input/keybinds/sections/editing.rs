...
impl ActionSet for ReaperEditing {
    ...
    fn keybinds(&self) -> Vec<Keybind> {
        vec![
            ...
            Keybind::new("<C-S-v>", "42398").with_description("Paste items/tracks preserving position"),
            ...
            // === Trim ===
            Keybind::new("<C-S-left>", "40225").with_description("Trim left edge of item to edit cursor"),
            Keybind::new("<C-S-right>", "40226").with_description("Trim right edge of item to edit cursor"),
...
impl ActionSet for LogicEditing {
    ...
    fn keybinds(&self) -> Vec<Keybind> {
        vec![
            ...
            Keybind::new("<S-D-g>", "40362").with_description("Glue items (ignoring time selection)"),
            Keybind::new("<C-f>", "40516").with_description("Item: Toggle item timebase between time and beats"),

            // === Nudging ===
            Keybind::new("<M-right>", "40793").with_description("Nudge item position right by grid"),
            ...
            Keybind::new("<M-D-s>", "40001").with_description("Insert new software instrument track"),
