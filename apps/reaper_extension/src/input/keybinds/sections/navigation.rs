...
impl ActionSet for LogicNavigation {
    ...
    fn keybinds(&self) -> Vec<Keybind> {
        vec![
            ...
            Keybind::new("<S-l>", "40717").with_description("Select all items in current time selection"),
            ...
            Keybind::new("<D-u>", "40290").with_description("Set locators by selection and enable cycle"),
