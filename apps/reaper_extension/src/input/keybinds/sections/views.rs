...
impl ActionSet for LogicViews {
    ...
    fn keybinds(&self) -> Vec<Keybind> {
        vec![
            ...
            Keybind::new("<C-M-v>", "40406").with_description("Show volume envelope for all tracks"),
...
/// FastTrackStudio views (vim-inspired)
pub struct FtsViews;

impl ActionSet for FtsViews {
    fn name(&self) -> &'static str {
        "FtsViews"
    }
    ...
    fn keybinds(&self) -> Vec<Keybind> {
        vec![
            ...
            Keybind::new("<D-1>", "40454").with_description("Load window set #1"),
            Keybind::new("<D-2>", "40455").with_description("Load window set #2"),
            Keybind::new("<D-3>", "40456").with_description("Load window set #3"),
            Keybind::new("<D-4>", "40457").with_description("Load window set #4"),

            // Quick toggles
            Keybind::new("<leader>m", "40078").with_description("Toggle mixer"),
            Keybind::new("<leader>e", "40271").with_description("Toggle media explorer"),
            Keybind::new("<leader>f", "40549").with_description("Toggle FX windows"),
        ]
    }
}
