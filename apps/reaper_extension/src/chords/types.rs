...
//!
//! Uses keyflow types for all musical structure. Only REAPER-specific timing
...
/// A detected chord with REAPER-specific timing information
///
/// The musical structure (chord, root note, bass note) comes from keyflow.
/// Only timing and MIDI data are REAPER-specific.
#[derive(Debug, Clone)]
...
///
/// This is REAPER-specific timing data. The pitch can be converted to
