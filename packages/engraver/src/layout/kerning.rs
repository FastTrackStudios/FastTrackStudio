...
mod tests {
    ...
    fn test_kern_limit_fraction() {
        assert_eq!(KerningType::KernUntilLeftEdge.kern_limit_fraction(), Some(0.0));
        assert_eq!(KerningType::KernUntilCenter.kern_limit_fraction(), Some(0.5));
        assert_eq!(KerningType::KernUntilRightEdge.kern_limit_fraction(), Some(1.0));
