...
fn calculate_notehead_offsets(notes: &[ChordNote], stem_dir: StemDirection) -> Vec<f64> {
    ...
    while idx != end_idx {
        ...
        if needs_mirror {
            ...
            offsets[i] = if is_up { notehead_width } else { -notehead_width };
        }
...
mod tests {
    ...
    fn test_notehead_offsets_no_conflict() {
        ...
        let notes = vec![
            ChordNote { line: 0, accidental: Accidental::None, tie: false },
            ChordNote { line: 2, accidental: Accidental::None, tie: false }, // Third apart
            ChordNote { line: 4, accidental: Accidental::None, tie: false }, // Third apart
        ];
    ...
    fn test_notehead_offsets_second_up_stem() {
        ...
        assert!(offsets[1] > 0.0, "Second note should be offset right for up-stem");
    }
    ...
    fn test_notehead_offsets_second_down_stem() {
        ...
        assert!(offsets[0] < 0.0, "Lower note should be offset left for down-stem");
    ...
    fn test_notehead_offsets_cluster() {
        ...
        let notes = vec![
            ChordNote { line: 0, accidental: Accidental::None, tie: false },
            ChordNote { line: 1, accidental: Accidental::None, tie: false },
    ...
    fn test_notehead_offsets_unison() {
        ...
        let notes = vec![
            ChordNote { line: 0, accidental: Accidental::None, tie: false },
            ChordNote { line: 0, accidental: Accidental::None, tie: false }, // Unison
        ];
        let offsets = calculate_notehead_offsets(&notes, StemDirection::Up);
