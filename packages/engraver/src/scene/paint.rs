...
impl PaintCommand {
    ...
    pub fn bounding_box(&self) -> Option<Rect> {
        match self {
            ...
            Self::Circle { center, radius, stroke_width, .. } => {
            ...
            Self::Ellipse { center, radius_x, radius_y, stroke_width, .. } => {
...
mod tests {
    ...
    fn test_line_command() {
        ...
        if let PaintCommand::Line { width, line_cap, .. } = cmd {
            assert_eq!(width, 2.0);
