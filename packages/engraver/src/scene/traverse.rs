...
mod tests {
    ...
    fn create_test_tree() -> SceneNode {
        ...
        let mut system = SceneNode::group(SemanticId::system(1))
            .with_position(Point::new(0.0, 100.0));

        let measure1 = SceneNode::group(SemanticId::measure(1))
            .with_position(Point::new(50.0, 0.0));
        let measure2 = SceneNode::group(SemanticId::measure(2))
            .with_position(Point::new(150.0, 0.0));
        ...
        impl SceneVisitor for SkipSystemVisitor {
            fn enter_node(&mut self, node: &SceneNode, _transform: Affine) -> bool {
                ...
                !matches!(
                    ...
                    Some(crate::scene::id::ElementType::System)
                )
            }
        }
