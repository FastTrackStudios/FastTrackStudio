...
impl MStyle {
    ...
    pub fn lead_sheet() -> Self {
        ...
        style.set(Sid::ChordStyle, StyleValue::ChordStyle(ChordStyleType::Standard));
        style
    }
    ...
    pub fn jazz_lead_sheet() -> Self {
        let mut style = Self::new();
        style.set(Sid::EnableVerticalSpread, StyleValue::Bool(true));
        style.set(Sid::ChordStyle, StyleValue::ChordStyle(ChordStyleType::Jazz));
