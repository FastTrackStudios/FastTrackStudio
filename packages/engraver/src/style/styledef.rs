...
mod tests {
    ...
    fn test_spatium_values() {
        ...
        assert_eq!(default_value(Sid::BarNoteDistance), StyleValue::Spatium(1.5));
        assert_eq!(default_value(Sid::NoteBarDistance), StyleValue::Spatium(1.0));
        assert_eq!(default_value(Sid::MinSystemDistance), StyleValue::Spatium(8.5));
    }
