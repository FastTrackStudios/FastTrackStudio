...
mod tests {
    ...
    fn test_parse_instrument_group() {
        ...
        assert_eq!(InstrumentGroup::parse("keys").unwrap(), InstrumentGroup::Keys);
        assert_eq!(InstrumentGroup::parse("keyboard").unwrap(), InstrumentGroup::Keys);
        assert_eq!(InstrumentGroup::parse("drums").unwrap(), InstrumentGroup::Drums);
        assert_eq!(InstrumentGroup::parse("bass").unwrap(), InstrumentGroup::Bass);
        assert_eq!(InstrumentGroup::parse("guitar").unwrap(), InstrumentGroup::Guitar);
        assert_eq!(InstrumentGroup::parse("gtr").unwrap(), InstrumentGroup::Guitar);
    }
    ...
    fn test_text_cue_with_measure() {
        let cue = TextCue::parse("@all \"Test\"")
            .unwrap()
            .at_measure(27);
    ...
    fn test_text_cue_with_beat() {
        let cue = TextCue::parse("@keys \"Test\"")
            .unwrap()
            .at_beat(2.5);
    ...
    fn test_to_lilypond_function() {
        ...
        list.add(TextCue::parse("@all \"Intro Groove!\"").unwrap().at_measure(27));
        list.add(TextCue::parse("@all \"Band Hits!\"").unwrap().at_measure(76));
