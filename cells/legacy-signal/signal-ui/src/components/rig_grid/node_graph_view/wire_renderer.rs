...
use super::super::node_graph::NodePosition;
use super::super::node_graph_wire::{wire_path_d, WirePath};

// ── Wire Draft ───────────────────────────────────────────────────────

/// Transient state for a wire being dragged from a port but not yet connected.
#[derive(Debug, Clone, PartialEq)]
pub(crate) struct WireDraft {
...
// ── Resolved wire (pre-computed for rendering) ───────────────────────

/// A resolved wire ready to render, produced by `resolve_all_wires`.
pub(crate) use super::super::node_graph_wire::ResolvedWire;

// ── SVG Wire Layer Component ─────────────────────────────────────────

#[derive(Props, Clone, PartialEq)]
pub(crate) struct WireLayerProps {
    pub canvas_w: f64,
    pub canvas_h: f64,
...
#[component]
pub(crate) fn WireLayer(props: WireLayerProps) -> Element {
