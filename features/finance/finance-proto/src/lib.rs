...
//!
//! Rename the `Finance` placeholder below to whatever the canonical
...
#[architect(table_name = "finance_items", repo)]
pub struct Finance {
...
pub trait FinanceService {
    ...
    async fn ping(&self) -> Result<String, FinanceServiceError>;
}
