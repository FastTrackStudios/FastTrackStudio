...
//!
//! Rename the `Cookbook` placeholder below to whatever the canonical
...
#[architect(table_name = "cookbook_items", repo)]
pub struct Cookbook {
...
pub trait CookbookService {
    ...
    async fn ping(&self) -> Result<String, CookbookServiceError>;
}
