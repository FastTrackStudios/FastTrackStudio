//! Loro-backed source-of-truth for the cookbook feature. Eight
//! entities, eight `EntityCrdt` impls, eight `*RepoLoro` newtypes.

use architect::{Page, RepoError, SortOrder};
use chrono::Utc;
use cookbook_proto::{
    Cookbook, CookbookCreate, CookbookList, CookbookRepo, CookbookUpdate, FoodProduct,
    FoodProductCreate, FoodProductList, FoodProductRepo, FoodProductUpdate, MealPlan,
    MealPlanCreate, MealPlanList, MealPlanRepo, MealPlanUpdate, PantryItem, PantryItemCreate,
    PantryItemList, PantryItemRepo, PantryItemUpdate, Recipe, RecipeCreate, RecipeIngredient,
    ...
    RecipeStepUpdate, RecipeUpdate, ShoppingListItem, ShoppingListItemCreate, ShoppingListItemList,
    ShoppingListItemRepo, ShoppingListItemUpdate,
};
use crdt::EntityCrdt;
use crdt::codec::{
