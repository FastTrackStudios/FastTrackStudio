...
//!
//! Rename the `Person` placeholder below to whatever the canonical
...
#[architect(table_name = "person_items", repo)]
pub struct Person {
...
pub trait PersonService {
    ...
    async fn ping(&self) -> Result<String, PersonServiceError>;
}
