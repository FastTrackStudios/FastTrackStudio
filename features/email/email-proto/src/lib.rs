//! `email-proto` — wire contract for the `email` feature.
//!
//! Rename the `Email` placeholder below to whatever the canonical
...
#[architect(table_name = "email_items", repo)]
pub struct Email {
...
pub trait EmailService {
    ...
    async fn ping(&self) -> Result<String, EmailServiceError>;
}
