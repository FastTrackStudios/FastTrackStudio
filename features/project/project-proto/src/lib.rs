...
//!
//! Rename the `Project` placeholder below to whatever the canonical
...
#[architect(table_name = "project_items", repo)]
pub struct Project {
...
pub trait ProjectService {
    ...
    async fn ping(&self) -> Result<String, ProjectServiceError>;
}
