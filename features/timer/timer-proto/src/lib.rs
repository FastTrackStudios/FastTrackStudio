//! `timer-proto` — wire contract for the `timer` feature.
//!
//! Rename the `Timer` placeholder below to whatever the canonical
...
#[architect(table_name = "timer_items", repo)]
pub struct Timer {
...
pub trait TimerService {
    ...
    async fn ping(&self) -> Result<String, TimerServiceError>;
}
