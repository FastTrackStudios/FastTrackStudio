...
mod crdt_tests {
    use vault_core::crdt::metadata::MetadataDoc;
    use vault_core::crdt::body::BodyDoc;
    use vault_core::crdt::document::CrdtDocument;
    use vault_core::task::{Task, Status, Priority};
