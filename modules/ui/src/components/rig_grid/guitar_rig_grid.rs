...
use dioxus::prelude::*;
use rig_control::id::BlockId;
use rig_control::module::Module;
use uuid::Uuid;
            ...
            div { class: "flex-1 overflow-auto",
                match current_mode() {
                    ModuleViewMode::Grid => rsx! {
                        // Signal flow grid view
                        div { class: "p-4",
                            SignalFlowGridView {
                                grid: grid.clone(),
                                on_block_click: props.on_block_click.clone(),
                                on_toggle_bypass: Some(props.on_toggle_block_bypass.clone()),
                            }
                        }
                    },
