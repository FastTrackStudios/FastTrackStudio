...
>"#;
    ...
    fn test_automation_item_parsing() {
        ...
        assert_eq!(automation_item.selected, true);
        assert_eq!(automation_item.baseline, 0.5);
        assert_eq!(automation_item.amplitude, 1.0);
        assert_eq!(automation_item.loop_enabled, true);
        ...
        assert_eq!(automation_item.muted, false);
