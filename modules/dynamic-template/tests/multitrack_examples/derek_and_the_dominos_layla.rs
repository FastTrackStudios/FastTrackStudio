...
fn derek_and_the_dominos_layla() -> Result<()> {
    ...
    let expected = TrackStructureBuilder::new()
        ...
        .folder("Vocals")
        .track("Lead", "27. Vocal_02.wav")
        .folder("BGVs")
        .folder("A")
        .track("A 1", "28.BG A Harm 1_02.wav")
        .track("A 2", "29.BG A Harm 2_02.wav")
        .track("A 3", "30.BG A Harm 3_02.wav")
        .track("A 4", "31.BG A Harm 4_02.wav")
        .end()
        .folder("B")
        .track("B 1", "32.BG B Harm 1_02.wav")
        .track("B 2", "33.BG B Harm 2_02.wav")
        .track("B 3", "34.BG B Harm 3_02.wav")
        .track("B 4", "35.BG B Harm 4_02.wav")
        .end()
        .folder("Harm 1")
        .track("C", "36.BG C Harm 1_02.wav")
        .track("Harm 1", "40.BG D Harm 1_02.wav")
        .track("Harm 2", "48.BG E Harm 1_02.wav")
        .end()
        .folder("Harm 2")
        .track("C", "37.BG C Harm 2_02.wav")
        .track("Harm 1", "41.BG D Harm 2_02.wav")
        .track("Harm 2", "49.BG E Harm 2_02.wav")
        .end()
        .folder("Harm 3")
        .track("C", "38.BG C Harm 3_02.wav")
        .track("Harm 1", "42.BG D Harm 3_02.wav")
        .track("Harm 2", "50.BG E Harm 3_02.wav")
        .end()
        .folder("BGVs")
        .track("BGVs 1", "45.BG D Harm 6_02.wav")
        .track("BGVs 2", "46.BG D Harm 7_02.wav")
        .track("BGVs 3", "47.BG D Harm 8_02.wav")
        .end()
        .folder("BGVs 4")
        .track("C", "39.BG C Harm 4_02.wav")
        .track("4 1", "43.BG D Harm 4_02.wav")
        .track("4 2", "51.BG E Harm 4_02.wav")
        .end()
        .track("BGVs 5", "44.BG D Harm 5_02.wav")
        .end()
        .end()
        .folder("Reference")
        .track(
            "Soyuz Bomblet Layla Cover Mix 1",
            "52.Soyuz Bomblet Layla Cover Mix_01.L.wav",
        )
        .track(
            "Soyuz Bomblet Layla Cover Mix 2",
            "52.Soyuz Bomblet Layla Cover Mix_01.R.wav",
        )
        .end()
        .build();
