...
fn laura_clapp_davidson_hey_hey_sister() -> Result<()> {
    ...
    let expected = TrackStructureBuilder::new()
        ...
        .folder("Unsorted")
            .track("OHS", "04.OHS_01.wav")
            .track("Hey_Sister_Licks", "12.Hey_Sister_Licks_01.wav")
            .track("Hey_Sister_Solo", "13.Hey_Sister_Solo_01.wav")
            .track("Laura Hey Hey High 1", "19.Laura Hey Hey High 1_01.wav")
            .track("Laura Hey Hey High 2", "20.Laura Hey Hey High 2_01.wav")
            .track("Laura Hey Hey Highest 1", "21.Laura Hey Hey Highest 1_01.wav")
            .track("Laura Hey Hey Highest 2", "22.Laura Hey Hey Highest 2_01.wav")
            .track("Laura Hey Hey Low 1", "23.Laura Hey Hey Low 1_01.wav")
            .track("Laura Hey Hey Low 2", "24.Laura Hey Hey Low 2_01.wav")
            .track("Laura Hey Hey Mid 1", "25.Laura Hey Hey Mid 1_01.wav")
            .track("Laura Hey Hey Mid 2", "26.Laura Hey Hey Mid 2_01.wav")
            .track("Hey Hey Sister", "27. Hey Hey Sister_01.wav")
        .end()
        .build();
