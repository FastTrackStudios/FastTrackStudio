...
fn led_zeppelin_the_ocean() -> Result<()> {
    ...
    let expected = TrackStructureBuilder::new()
        ...
        .end()
        .folder("Guitars")
            .track("L Main Riff.A1", "09. Gtr L Main Riff.A1_01.wav")
            .track("L Main Riff.A2", "10. Gtr L Main Riff.A2_01.wav")
            .track("Gtr_L.A1", "11. Gtr_L.A1_01.wav")
            .track("Gtr_L.A2", "12. Gtr_L.A2_01.wav")
            .track("Gtr_R.A1", "13. Gtr_R.A1_01.wav")
        ...
        .folder("Unsorted")
            ...
            .track("Lead_1.A2", "16. lead_1.A2_01.wav")
            .track("Lead_2.A1", "17. lead_2.A1_01.wav")
            .track("Lead_2.A2", "18. lead_2.A2_01.wav")
            .track("The Ocean", "28. The Ocean_01.wav")
        .end()
        .build();
