...
fn find_chord_by_symbol<'a>(section: &'a keyflow::chart::ChartSection, symbol: &str) -> Option<&'a ChordInstance> {
...
"#;
    ...
    match chord_c.push_pull {
        ...
        _ => panic!("Expected Push(Sixteenth) for ''C, got {:?}", chord_c.push_pull),
    }
    ...
    match chord_em.push_pull {
        ...
        _ => panic!("Expected Push(Sixteenth) for ''Em, got {:?}", chord_em.push_pull),
    }
}
...
"#;
    ...
    match chord1.push_pull {
        ...
        _ => panic!("Expected Pull(ThirtySecond) for C''', got {:?}", chord1.push_pull),
    }
    ...
    match chord3.push_pull {
        ...
        _ => panic!("Expected Pull(ThirtySecond) for Em''', got {:?}", chord3.push_pull),
    }
}
