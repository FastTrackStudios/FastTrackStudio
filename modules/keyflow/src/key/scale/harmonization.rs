...
use crate::primitives::{MusicalNote, RootNotation, Note};
...
pub fn generate_scale_notes(root: &MusicalNote, interval_pattern: &[u8]) -> Vec<MusicalNote> {
    ...
    for (i, &semitone_offset) in interval_pattern.iter().enumerate() {
        ...
        result.push(MusicalNote::from_letter_and_accidental(expected_letter, accidental));
    }
...
pub fn harmonize_scale(mode: &ScaleMode, root: &MusicalNote, depth: HarmonizationDepth) -> Vec<Chord> {
...
fn build_chord_at_degree(
    ...
    from_semitones(&normalized_semitones, chord_root_notation.clone())
        .unwrap_or_else(|_| {
...
pub fn analyze_scale_harmony(mode: ScaleMode, root: MusicalNote, depth: HarmonizationDepth) -> String {
...
mod tests {
    ...
    fn test_harmonize_c_major_sevenths() {
        ...
        assert_eq!(chords[6].quality, crate::chord::ChordQuality::Diminished);
        assert_eq!(chords[6].family, Some(crate::chord::ChordFamily::HalfDiminished));
    }
    ...
    fn test_dorian_mode_harmonization() {
        ...
        assert_eq!(chords[5].family, Some(crate::chord::ChordFamily::HalfDiminished));
    ...
    fn test_phrygian_mode_harmonization() {
        ...
        assert_eq!(chords[4].family, Some(crate::chord::ChordFamily::HalfDiminished));
    ...
    fn test_lydian_mode_harmonization() {
        ...
        assert_eq!(chords[3].family, Some(crate::chord::ChordFamily::HalfDiminished));
    ...
    fn test_mixolydian_mode_harmonization() {
        ...
        assert_eq!(chords[2].family, Some(crate::chord::ChordFamily::HalfDiminished));
    ...
    fn test_aeolian_mode_harmonization() {
        ...
        assert_eq!(chords[1].family, Some(crate::chord::ChordFamily::HalfDiminished));
    ...
    fn test_locrian_mode_harmonization() {
        ...
        assert_eq!(chords[0].family, Some(crate::chord::ChordFamily::HalfDiminished));
    ...
    fn test_analyze_scale_harmony() {
        let mode = ScaleMode::ionian();
        let root = c_note();
        let analysis = analyze_scale_harmony(mode.clone(), root.clone(), HarmonizationDepth::Triads);
    ...
    fn get_roman_numeral(degree: usize, quality: &crate::chord::ChordQuality, _family: Option<&crate::chord::ChordFamily>) -> String {
    ...
    fn test_ionian_scale_degrees_and_notes() {
        let mode = ScaleMode::ionian();
        let root = c_note();
        let harmonization = ScaleHarmonization::new(mode, root.clone(), HarmonizationDepth::Sevenths);
        ...
        for (i, ((chord, expected_note), expected_roman)) in harmonization.chords.iter()
