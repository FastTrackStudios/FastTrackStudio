...
use crate::time::{MusicalDuration, AbsolutePosition};
...
impl KeyChange {
    pub fn new(position: AbsolutePosition, from_key: Option<crate::key::Key>, to_key: crate::key::Key, section_index: usize) -> Self {
        Self {
            position,
            from_key,
            to_key,
...
impl TimeSignatureChange {
    pub fn new(position: AbsolutePosition, time_signature: crate::time::TimeSignature, section_index: usize) -> Self {
        Self {
            position,
            time_signature,
            section_index,
