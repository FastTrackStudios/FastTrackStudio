...
pub use crate::marker_region::core::{MarkerRegionSource, MarkerSource, RegionSource};
...
impl MarkerRegionSourceBuilder {
    ...
    pub fn build_rpp(
        self,
        path: &str,
    ) -> Result<RppMarkerRegionSource, crate::marker_region::core::MarkerRegionError> {
...
mod tests {
    use super::*;
    use crate::marker_region::core::MarkerRegionSource;
