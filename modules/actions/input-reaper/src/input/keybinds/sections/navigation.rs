...
impl ActionSet for FtsNavigation {
    ...
    fn keybinds(&self) -> Vec<Keybind> {
        vec![
            ...
            // === Global Commands ===
            Keybind::new("<S-/>", "40605").with_description("Show action list"),
            Keybind::new("<M-.>", "40016").with_description("Open preferences"),
            Keybind::new("<M-S-.>", "40099").with_description("Open audio device configuration"),
        ]
    }
}
