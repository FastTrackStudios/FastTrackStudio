...
use crate::naming_convention::{SimpleParser, FullGroup};
...
impl TrackList {
    ...
    fn build_hierarchy_name_from_parsed(&self, parsed: &crate::naming_convention::TrackName, track_name: Option<&str>) -> String {
