...
mod dioxus_impl {
    ...
    pub static TRANSPORT_INFO: GlobalSignal<HashMap<String, ProjectTransportInfo>> =
    ...
    pub static SONG_TRACKS: GlobalSignal<HashMap<usize, Vec<daw::tracks::Track>>> =
        Signal::global(|| HashMap::new());
    ...
    pub static SONG_TRANSPORT: GlobalSignal<HashMap<usize, daw::transport::Transport>> =
        Signal::global(|| HashMap::new());
    ...
    pub static SETLIST_STRUCTURE: GlobalSignal<Option<crate::setlist::core::Setlist>> =
        Signal::global(|| None);

    /// Active indices (song, section, slide) - updates frequently during playback
    pub static ACTIVE_INDICES: GlobalSignal<(Option<usize>, Option<usize>, Option<usize>)> =
    ...
    pub static QUEUED_NAME: GlobalSignal<(String, String)> =
        Signal::global(|| (String::new(), String::new()));
