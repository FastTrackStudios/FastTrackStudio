...
pub struct ParseContext<'a> {
    ...
    pub group_config: Option<&'a crate::smart_template::core::models::group_config::GroupConfig>,
}
...
impl<'a> ParseContext<'a> {
    ...
    pub fn with_group_config(mut self, config: &'a crate::smart_template::core::models::group_config::GroupConfig) -> Self {
...
pub trait ComponentParser: Send + Sync {
    ...
    fn group_patterns(&self, context: &ParseContext) -> Option<Vec<String>> {
        ...
        context.group_config.and_then(|_config| {
            _config.component_patterns.as_ref().and_then(|_patterns| {
