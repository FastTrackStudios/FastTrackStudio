...
use crate::smart_template::naming_convention::{TrackName, SimpleParser, format_track_name_default};
...
impl std::fmt::Debug for TrackMatcher {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("TrackMatcher")
            .field("track_count", &self.track_list.len())
            .finish()
    }
}
