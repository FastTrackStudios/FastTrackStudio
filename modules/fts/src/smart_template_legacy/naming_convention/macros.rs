...
/// - `children` - Array of nested `Group` instances (can use nested `define_group!` calls)
#[macro_export]
macro_rules! define_group {
    {
        ...
        {
            let mut group = $crate::smart_template::naming_convention::Group::new($name, $prefix);
            ...
            // Group type
            $(group.group_type = Some($crate::smart_template::naming_convention::GroupType::$group_type);)?
