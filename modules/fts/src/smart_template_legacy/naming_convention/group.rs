...
use super::component_patterns::{ComponentPatternProvider, ComponentPatterns};
use super::component::ComponentType;
use super::multi_mic_descriptor::MultiMicDescriptor;
...
impl<'a> MultiMicBuilder<'a> {
    fn new(group: &'a mut Group, name: impl Into<String>) -> Self {
        Self {
            group,
...
/// Group definition with all configuration
/// 
/// Groups can be nested recursively to create hierarchies of any depth.
...
impl Group {
    ...
    pub fn get_arrangement_patterns(&self, child_group: Option<&Group>) -> Vec<String> {
    ...
    pub fn get_section_patterns(&self, child_group: Option<&Group>) -> Vec<String> {
        if let Some(child) = child_group {
    ...
    pub fn get_multi_mic_patterns(&self, child_group: Option<&Group>) -> Vec<String> {
        if let Some(child) = child_group {
